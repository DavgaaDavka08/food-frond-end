  ...
  return (
    <div className="flex h-[550px] max-w-[1200px]  flex-wrap p-5 items-start gap-4">
      ...
      {addCategory.map((data: FoodType, index) => (
        <div
          key={index}
          className="w-[270px] flex-wrap gap-3  h-[242px] flex flex-col justify-center items-center sm:p-4 flex-1 self-stretch rounded-[20px] border"
        >
          <Image
            alt="Food image"
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between items-center gap-[10px]">
              ...
              <p className=" text-xs font-normal leading-4 font-inter">
                ${data.price}
              </p>
            </div>
            <div>
              <p className=" text-[14px] font-normal leading-4 font-inter border ">
                {data.ingredients}
              </p>
            </div>
          </div>
